...
exports.TextGenApiClient = void 0;
...
class TextGenApiClient extends VoxtaApiClientBase_1.VoxtaApiClientBase {
    generateText(request, callback) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            yield (0, fetch_event_source_1.fetchEventSource)(`${this.baseURL}/text/generate`, {
                method: 'POST',
                headers: {
    ...
    countTokens(text) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const response = yield axios_1.default.post(`${this.baseURL}/text/count-tokens`, {
                text,
            });
...
exports.TextGenApiClient = TextGenApiClient;
//# sourceMappingURL=TextGenApiClient.js.map